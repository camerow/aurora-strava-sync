...
function DefaultErrorComponent() {
  ...
  let devInfo = null;
  {
    ...
    devInfo = /* @__PURE__ */ reactExports.createElement(
      ...
      /* @__PURE__ */ reactExports.createElement(
        ...
        /* @__PURE__ */ reactExports.createElement("code", { style: codeStyles }, "ErrorBoundary"),
        " or",
        " ",
        /* @__PURE__ */ reactExports.createElement("code", { style: codeStyles }, "errorElement"),
        " prop on your route."
      )
    );
  }
  return /* @__PURE__ */ reactExports.createElement(
    ...
    /* @__PURE__ */ reactExports.createElement("h3", { style: { fontStyle: "italic" } }, message),
    stack ? /* @__PURE__ */ reactExports.createElement("pre", { style: preStyles }, stack) : null,
    devInfo
  );
}
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary
    ...
    : route.id === "root"
      ? () =>
          /* @__PURE__ */ reactExports.createElement(RemixRootDefaultErrorBoundary, {
            error: useRouteError(),
          })
      : void 0;
...
function PrefetchPageLinks({ page, ...linkProps }) {
  ...
  if (rsc) {
    return /* @__PURE__ */ reactExports.createElement(RSCPrefetchPageLinksImpl, {
      page,
      matches,
      ...linkProps,
    });
...
function RSCPrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
  ...
  }, [basename, future.v8_trailingSlashAwareDataRequests, page, location, nextMatches]);
  return /* @__PURE__ */ reactExports.createElement(
    reactExports.Fragment,
    null,
    dataHrefs.map((href) =>
...
function BoundaryShell({ title: title2, renderScripts, isOutsideRemixApp, children }) {
  ...
  return /* @__PURE__ */ reactExports.createElement(
    ...
    /* @__PURE__ */ reactExports.createElement(
      ...
      /* @__PURE__ */ reactExports.createElement("title", null, title2)
    ),
    /* @__PURE__ */ reactExports.createElement(
      "body",
      null,
      /* @__PURE__ */ reactExports.createElement(
        ...
        children,
        renderScripts ? /* @__PURE__ */ reactExports.createElement(Scripts, null) : null
      )
    )
  );
}
...
try {
  if (isBrowser2) {
    window.__reactRouterVersion = "7.18.2"; // @ts-expect-error
  }
} catch (e) {}
var Link = reactExports.forwardRef(function LinkWithRef(
  ...
  return shouldPrefetch && !isAbsolute
    ? /* @__PURE__ */ reactExports.createElement(
        ...
        null,
        link,
        /* @__PURE__ */ reactExports.createElement(PrefetchPageLinks, { page: href })
      )
    : link;
});
...
function ErrorWrapper({ renderAppShell, title: title2, children }) {
  if (!renderAppShell) {
    return children;
  }
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      "head",
      null,
      /* @__PURE__ */ React.createElement("meta", { charSet: "utf-8" }),
      /* @__PURE__ */ React.createElement("meta", {
        name: "viewport",
        content: "width=device-width,initial-scale=1,viewport-fit=cover",
      }),
      /* @__PURE__ */ React.createElement("title", null, title2)
    ),
    /* @__PURE__ */ React.createElement(
      "body",
      null,
...
const requestHandler = createRequestHandler(
  () => import("./server-build-GYL2bLrF.js"),
  "production"
);
const app = {
