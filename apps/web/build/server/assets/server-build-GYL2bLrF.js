import {
  ...
  M as Meta,
  L as Links,
  a as ScrollRestoration,
  b as Scripts,
  O as Outlet,
  R as React,
} from "./worker-entry-B7TeQZ__.js";
import "node:events";
    ...
    switch (type) {
      ...
      case "img":
        ...
        if (
          ...
          var sizes2 = "string" === typeof props.sizes ? props.sizes : void 0,
...
const designStyles = "/assets/styles-DvSOt3TV.css";
const links = () => [
  {
    rel: "stylesheet",
    href: designStyles,
...
function Badge({ tone = "gold", pill = true, children, style }) {
...
function Card({ float = false, pad = 26, radius = "var(--radius-card)", children, style }) {
...
function GradeBars({ bars = [], height = 64 }) {
...
function Label({ on = "dark", size = 11, children, style }) {
  const color =
    on === "dark"
...
function ActivityCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatStrip, { stats }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, {
            on: "light",
            size: 10,
            children: "SENDS BY GRADE",
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(GradeBars, { bars }),
        ],
      }),
    ],
  });
...
function Button({
  ...
  if (href !== void 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href, ...shared, children });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", ...shared, children });
}
function Input({ onDark = false, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("input", {
    ...
    style: {
      ...
      boxShadow: focus
        ...
        : "none",
      borderColor: focus && !onDark ? "var(--bs-azure)" : void 0,
      ...style,
    },
  });
}
function Mark({ inverse = false, size, style }) {
...
function Logo({ variant = "lockup", tone = "on-dark", size = 32, style }) {
  const onLight = tone === "on-light";
  if (variant === "mark")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Mark, { inverse: onLight, size, style });
...
function SpecRow({ label, children, last = false, labelWidth = 150 }) {
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityCard, {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SpecRow, {
                label: "ACTIVITY TYPE",
...
const home = withComponentProps(function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Boards, {}),
